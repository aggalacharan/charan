...
//working	
	...
	public ResponseEntity<Restaurant> deleteRestaurant(@PathVariable Integer restaurantId) throws RestaurantException{
...
//working
	...
	public ResponseEntity<Restaurant> getByResturantId(@PathVariable Integer restaurantId) throws RestaurantException{
	...
	// need to work on code to  view all resturants 
