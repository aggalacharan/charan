...
//	}
	...
	@PostMapping("/add/{restaurantId}")
    public ResponseEntity<menuItem> addItemToRestaurant(@RequestBody menuItem item, @PathVariable Integer restaurantId) {
        try {
    ...
    //working to food item to a particular restaurent based on the id
	...
	public ResponseEntity<menuItem> getItem(@PathVariable Integer itemId) throws ItemException{
	...
	public ResponseEntity<menuItem> removeItem(@PathVariable Integer itemId) throws ItemException{
